...
class ItemFiscal(Base):
    ...
    aliq_st = Column(Float, default=0.0)
    vl_icms_st = Column(Float, default=0.0)
    ind_apur = Column(String)
    cst_ipi = Column(String)
    cod_enq = Column(String)
    vl_bc_ipi = Column(Float, default=0.0)
    aliq_ipi = Column(Float, default=0.0)
    vl_ipi = Column(Float, default=0.0)
    cst_pis = Column(String)
    vl_bc_pis = Column(Float, default=0.0)
    aliq_pis = Column(Float, default=0.0)
    quant_bc_pis = Column(Float, default=0.0)
    aliq_pis_r = Column(Float, default=0.0)
    vl_pis = Column(Float, default=0.0)
    cst_cofins = Column(String)
    vl_bc_cofins = Column(Float, default=0.0)
    aliq_cofins = Column(Float, default=0.0)
    quant_bc_cofins = Column(Float, default=0.0)
    aliq_cofins_r = Column(Float, default=0.0)
    vl_cofins = Column(Float, default=0.0)
    cod_cta = Column(String)
    cod_item_pai = Column(String)
